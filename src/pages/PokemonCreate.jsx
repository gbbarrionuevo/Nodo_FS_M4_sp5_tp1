...
const PokemonCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await alert(`¿Estás seguro de crear a ${name}?`, {
      icon: "warning",
    ...
    try {
      await pokeCreate({ name, image, types, height, weight, base_experience, abilities, hp, attack, defense });
      notify('Pokémon creado correctamente', 'success');
      navigate('/pokemon/list');
    } catch (error) {
      notify('Ocurrió un error al crear el pokémon', 'error');
      console.error('Ocurrió un error al crear el pokémon', error);
    }
  };
  ...
  return (
    <PageTransition>
      <div className="mt-8">
        <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-6 tracking-wide">Crear Pokémon</h2>
